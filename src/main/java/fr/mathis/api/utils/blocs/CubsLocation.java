package fr.mathis.api.utils.blocs;
...
public class CubsLocation {
    ...
    public CubsLocation(Location loc1, Location loc2) {
    ...
    public CubsLocation(Location minLoc, Location maxLoc, int minX, int minY, int minZ, int maxX, int maxY, int maxZ) {
        this.minLoc = minLoc;
        this.maxLoc = maxLoc;
        this.minX = minX;
        this.minY = minY;
